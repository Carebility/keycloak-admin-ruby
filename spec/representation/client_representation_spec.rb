RSpec.describe KeycloakAdmin::ClientRepresentation do
  describe "#to_json" do
    ...
    it "serializes its fields to json with camelCased keys" do
      ...
      # Nested attributes hash keeps its (already Keycloak-style) keys verbatim.
      expect(json["attributes"]).to include("access.token.lifespan" => "86400")
    end
  end
end
